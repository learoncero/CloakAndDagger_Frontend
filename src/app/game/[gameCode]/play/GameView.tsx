...
export default function GameView({
    ...
    const isSabotageActive = (sabotageId: number) => {
    ...
    const handleToggleMiniMap = () => {
        if (!isSabotageActive(3) || currentPlayer.role == Role.IMPOSTOR) {
            setShowMiniMap(!showMiniMap);
        } else if (isSabotageActive(3) && !isImpostor) {
    ...
    }, [handleKill, handleToggleMiniMap, handleReportBody]);
    ...
    }, [game.gameCode, handleToggleTaskPopup, nearbyTasks, showTaskPopup, currentPlayer?.role]);
    ...
    }, [nearbySabotages, handleCancelSabotage, showMiniMap]);
